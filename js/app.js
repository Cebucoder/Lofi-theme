...
// let userFElement = document.getElementById("user-f").innerHTML = `${userData.charAt(0)}`;
// userFElement.innerHTML = userData.charAt(0);
...
function ShowTodoList(){
    ...
    document.getElementById("task-complete").innerHTML = taskCount;
